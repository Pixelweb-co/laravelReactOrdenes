          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            {products && products.length > 0 && products.map((product,index) => {
              ...
              return(
                ...
                <tr key={product.id} className="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                  <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                    ...
                    >
                     <Link to={("/admin/formulario-producto/"+product.id)}>  {product.nombre}</Link>
                     </span>
                  </th>
                  ...
                  {product.id ? ( 
                    <TableDropdown idStudent={product.id} setDisplay={()=>props.showDelete(true,product.id)} />
                  ) : ''}
                  </td>
                </tr>
              )
